...
public class Teacher {
    ...
    public Teacher() {}
    public Teacher(int id, String name, String subject, String qualification, Integer classAssigned){
        this.id=id;
        this.name=name;
    ...
    public Teacher(String name, String subject, String qualification, Integer classAssigned){
        this(0,name,subject,qualification,classAssigned);}
